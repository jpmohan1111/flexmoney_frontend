...
const AboutUs = (props) => {
  ...
  useEffect(() => {
    ...
    var pastexp_swiper2 = new Swiper(".landersec3_swiper.swiper-container", {
      //   effect: "coverflow",
      grabCursor: true,
      centeredSlides: true,
      loop: true,
      ...
      //   navigation: {
      //     nextEl: ".landersec2 .right_arrow",
      //     prevEl: ".landersec2 .left_arrow",
      //   },
      pagination: {
        el: ".landersec2 .swiper-pagination",
        clickable: true,
      },
    });
    ...
    var ourteam_swiper = new Swiper(".ourteam_swiper.swiper-container", {
      ...
      pagination: {
        el: ".landersec3 .swiper-pagination",
        clickable: true,
      },
    });

    var landersec5_swiper = new Swiper(".landersec5_swiper.swiper-container", {
      slidesPerView: 1,
      spaceBetween: 30,
      loop: true,
      autoHeight: false,
      ...
      pagination: {
        el: ".landersec5 .swiper-pagination",
        clickable: true,
      },
      //   navigation: {
      //     nextEl: ".landersec5 .right_arrow",
  ...
  return (
    <>
      <section className="landersec1 wow fadeIn">
        <Breadcrumb history={props.history} t2="Careers" />
        <div className="main-head">
          <div className="title">Lenders</div>
          <div className="desc">
            Offer branded Cardless EMI <br /> & Pay Later across our
            omni-channel
            <br /> Merchant Network
          </div>
        </div>
      </section>
      <section className="landersec2 wow fadeInUp" data-wow-duration="2s">
        <Row className="m-0">
          <Col lg={12} className="p-0">
            <div className="d-f j-c ">
              ...
              <div className="landersec3_swiper swiper-container">
        ...
        <Row className=" networks">
          <div>
            <div className="network">
              <img src="/lenders/fashion_and_clothing.png" alt="1" />
              <p className="network__desc">Fashion & Clothing</p>
            </div>
            <div className="network">
              <img src="/lenders/travel_and_holidays.png" alt="1" />
              <p className="network__desc">Travel & Holidays</p>
            </div>
            <div className="network">
              <img src="/lenders/laptops_and_tablets.png" alt="1" />
              <p className="network__desc">Laptops & Tablets</p>
            </div>
            <div className="network">
              <img src="/lenders/fitness.png" alt="1" />
              <p className="network__desc">Fitness & Personal Care</p>
            </div>
            <div className="network">
              <img src="/lenders/electronics.png" alt="1" />
              <p className="network__desc">Electronics & Appliances</p>
            </div>
            <div className="network">
              <img src="/lenders/laptops.png" alt="1" />
              <p className="network__desc">Laptops & Tablets</p>
            </div>
            <div className="network">
              <img src="/lenders/education.png" alt="1" />
              <p className="network__desc">Laptops & Tablets</p>
            </div>
            <div className="network">
              <img src="/lenders/mobiles.png" alt="1" />
              <p className="network__desc">Mobiles</p>
            </div>
            <div className="network">
